...
'.getHousehold(HID);';
  ...
  return '<!DOCTYPE html><html><head><base target="_top"><meta charset="utf-8">' +
    ...
    '<a id="gcalLink" href="#" target="_blank" style="display:none;margin-top:28px;font-family:\'DM Sans\',sans-serif;font-size:12px;letter-spacing:.14em;text-transform:uppercase;color:var(--sage);text-decoration:none;border:1px solid rgba(107,127,106,.4);padding:10px 20px;border-radius:2px;transition:.2s"></a></div>' +
